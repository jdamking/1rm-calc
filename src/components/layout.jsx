...
export default function Layout(props) {
    ...
    return (
        <div className='bg-dark min-h-screen text-slate-50'> 
                <header className='flex flex-col p-6 sm:p-5 border-b border-verydark dark:border-light duration-200'>
                    ...
                    This calculator will help you determine about what your one repition max is</p>
                <main className='flex flex-col py-16 sm:py-20 gap-8 max-w-[600px] w-full mx-auto'>
                    {children}
                </main>
            <footer className='bg-dark text-slate-50 flex p-8 py-16 text-xs sm:text-sm border-t border-verydark dark:border-light duration-200 item-center justify-center flex-col gap-6 '>
